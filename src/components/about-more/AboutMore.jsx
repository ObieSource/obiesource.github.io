...
const AboutMore = () => {
  return (
    <div className="obs__about-more">
      <div className="obs__about-more-heading">&#123;What do we do?&#125;</div>

      <div className="obs__about-more-description">
        Oberlin Open Source Club (ObieSource) is a club in which students can
        interact with Oberlin-specific open source projects.
        <span className="emph-text">
          {" "}
          Anyone can join, and anyone can contribute to our projects.
        </span>{" "}
        To see what we're working on, checkout our{" "}
        <a href="https://github.com/ObieSource" className="link-text">
          GitHub Page
        </a>
