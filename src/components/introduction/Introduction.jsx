    ...
    <div className='obs__introduction'>
      ...
      <div className='obs__introduction-description-buls'> 
        <div className='obs__introduction-description description_first-bul' >
          ...
          <p>Members can present about their projects and find their teammates.</p>
        </div>
        ...
        <div className='obs__introduction-description description_third-bul'>
          ...
          <p>Hone your collaboration skills, as well as learn new technologies.</p>
        </div>
        <div className='obs__introduction-links'><a href="/about">Learn More</a></div> 
        </div>
      </div>
      <div className='obs__introduction'>
